...
data0 = [(r'mpl-data', glob.glob(r'C:\Python25\Lib\site-packages\matplotlib\mpl-data\*.*')),
...
setup(windows=[{"script" : "main.py"}], options=opts,   data_files=data0)